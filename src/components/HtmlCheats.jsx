...
const Section = ({ title, children }) => (
  ...
  const TagExample = ({ tag, description, example, demo, attributes, selfClosing, notes }) => (
  <div className="mb-6">
  ...
  return (
    <div className="html-reference-container p-6 max-w-7xl mx-auto">
      <header className="text-center mb-10">
        <h1 className="text-4xl font-bold mb-4">📚 Повний довідник HTML тегів</h1>
        <p className="text-xl text-gray-400">Усі HTML-елементи з прикладами використання</p>
      </header>
      ...
      <Section title="📌 Основні теги">
        ...
        <TagExample
          ...
          example={`<body>\n  <h1>Привіт, світ!</h1>\n</body>`}
          attributes={['onafterprint', 'onbeforeprint', 'onbeforeunload', 'onblur', 'onerror', 'onfocus', 'onload', 'onmessage', 'onoffline', 'ononline', 'onpopstate', 'onresize', 'onscroll', 'onsearch', 'onsubmit', 'onunload']}
        />
        ...
        <TagExample
          ...
          attributes={['rel', 'href', 'type', 'sizes', 'media', 'hreflang', 'crossorigin', 'integrity']}
        />
        ...
        <TagExample
          ...
          attributes={['src', 'async', 'defer', 'type', 'charset', 'crossorigin', 'integrity', 'nomodule', 'nonce']}
        />
      ...
      <Section title="🏗️ Структурні теги">
        ...
        <TagExample
          ...
          attributes={['class', 'id', 'style', 'accesskey', 'contenteditable', 'dir', 'draggable', 'hidden', 'lang', 'spellcheck', 'tabindex', 'title', 'translate']}
        />
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map(level => (
            <TagExample
              ...
              demo={<React.Fragment>{/* Використовуємо стандартний тег h */}
                {level === 1 && <h1 className="font-bold">Заголовок {level}</h1>}
                {level === 2 && <h2 className="font-bold">Заголовок {level}</h2>}
                {level === 3 && <h3 className="font-bold">Заголовок {level}</h3>}
                {level === 4 && <h4 className="font-bold">Заголовок {level}</h4>}
                {level === 5 && <h5 className="font-bold">Заголовок {level}</h5>}
                {level === 6 && <h6 className="font-bold">Заголовок {level}</h6>}
              </React.Fragment>}
        ...
        <TagExample
          ...
          demo={<p>Це приклад абзацу тексту. Тут може бути довгий текст, який автоматично переноситься на нові рядки.</p>}
          attributes={['align', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<div>Перший рядок<br />Другий рядок</div>}
          selfClosing
...
{`function hello() {
  console.log("Hello");
        ...
        <TagExample
          ...
          demo={
            <blockquote className="border-l-4 border-gray-500 pl-4 italic">
              <p>Це приклад цитати. Вона зазвичай виділяється відступами та курсивом.</p>
            </blockquote>
          }
        ...
        <TagExample
          ...
          demo={<code className="bg-gray-800 px-2 py-1 rounded">console.log()</code>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<samp className="bg-gray-800 px-2 py-1 rounded font-mono">Hello World</samp>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<div>Натисніть <kbd className="bg-gray-700 px-2 py-1 rounded border border-gray-600">Enter</kbd></div>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<div>Це <mark className="bg-y-200 text-yellow-900">важливий</mark> текст</div>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<div>Це <em>дуже</em> важливо</div>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<div><dfn>HTML</dfn> - мова розмітки</div>}
      ...
      <Section title="🔗 Посилання та зображення">
        <TagExample
          ...
          demo={<a href="#link" className="text-blue-400 hover:underline">Приклад посилання</a>}
          attributes={['href', 'target', 'download', 'rel', 'hreflang', 'type', 'referrerpolicy', 'ping']}
        />
        ...
        <TagExample
          ...
          attributes={['src', 'alt', 'width', 'height', 'loading', 'srcset', 'sizes', 'crossorigin', 'referrerpolicy', 'ismap', 'usemap']}
          selfClosing
        />
...
`<picture>
  ...
  <img src="small.jpg" alt="Опис">
          ...
          demo={
            <picture>
              <source media="(min-width: 800px)" srcSet="https://cdn.fishki.net/upload/post/2021/02/16/3613245/tn/alberta-2297204-1280.jpg" />
              <source media="(min-width: 400px)" srcSet="https://cdn.fishki.net/upload/post/2021/02/16/3613245/tn/alberta-2297204-1280.jpg" />
              <img
  ...
  <figcaption>Рис. 1 - Діаграма</figcaption>
          ...
          demo={
            <figure className="border border-gray-600 p-2 max-w-xs">
              <img src="https://cdn.fishki.net/upload/post/2021/02/16/3613245/tn/alberta-2297204-1280.jpg" alt="Приклад ілюстрації" />
              <figcaption className="text-center mt-2 text-sm">Рис. 1 - Приклад ілюстрації</figcaption>
            </figure>
          }
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<figcaption className="text-center mt-2 text-sm">Приклад підпису</figcaption>}
          attributes={['class', 'id', 'style']}
        />
...
<img src="image.jpg" usemap="#workmap">`
        ...
        <TagExample
          ...
          attributes={['shape', 'coords', 'href', 'alt', 'target', 'download', 'rel', 'hreflang', 'type', 'referrerpolicy']}
          selfClosing
        />
      </Section>
      ...
      <Section title="🔊 Аудіо та відео">
        <TagExample
          ...
          attributes={['src', 'controls', 'autoplay', 'loop', 'muted', 'preload', 'volume', 'crossorigin']}
        />
        ...
        <TagExample
          ...
          demo={
            <video controls width="320" height="240" src="https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4">
              Ваш браузер не підтримує відео.
            </video>
          }
          attributes={['src', 'controls', 'autoplay', 'loop', 'muted', 'poster', 'width', 'height', 'preload', 'playsinline', 'crossorigin']}
        />
      ...
      <Section title="📦 Вбудований контент">
        <TagExample
          ...
          demo={<iframe src="https://wikipedia.org" height="200" className="w-full border"></iframe>}
          attributes={['src', 'width', 'height', 'name', 'sandbox', 'allowfullscreen', 'allow', 'loading', 'referrerpolicy']}
        />
    ...
    <tr><td>Дані</td></tr>
          ...
          demo={
            <table className="border border-gray-600 w-full">
              <caption className="caption-top mb-2 font-bold">Приклад таблиці</caption>
              <thead>
                <tr>
                  <th className="border border-gray-600 p-2 bg-gray-700">Заголовок 1</th>
                  <th className="border border-gray-600 p-2 bg-gray-700">Заголовок 2</th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          attributes={['border', 'cellpadding', 'cellspacing', 'summary', 'width', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<caption className="caption-top mb-2 font-bold">Приклад заголовку</caption>}
          attributes={['align', 'class', 'id', 'style']}
        />
...
`<thead>
  <tr><th>Заголовок</th></tr>
          ...
          demo={
            <thead>
              <tr>
                <th className="border border-gray-600 p-2 bg-gray-700">Приклад заголовку</th>
              </tr>
            </thead>
          }
          attributes={['align', 'char', 'charoff', 'valign', 'class', 'id', 'style']}
        />
...
`<tfoot>
  <tr><td>Підсумок</td></tr>
          ...
          demo={
            <tfoot>
              <tr>
                <td className="border border-gray-600 p-2 bg-gray-700">Приклад підвалу</td>
              </tr>
            </tfoot>
          }
          attributes={['align', 'char', 'charoff', 'valign', 'class', 'id', 'style']}
        ...
        <TagExample
          ...
          attributes={['align', 'bgcolor', 'char', 'charoff', 'valign', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<th className="border border-gray-600 p-2 bg-gray-700">Приклад заголовку</th>}
          attributes={['abbr', 'align', 'axis', 'bgcolor', 'char', 'charoff', 'colspan', 'headers', 'rowspan', 'scope', 'valign', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          attributes={['abbr', 'align', 'axis', 'bgcolor', 'char', 'charoff', 'colspan', 'headers', 'rowspan', 'valign', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          attributes={['span', 'align', 'char', 'charoff', 'valign', 'width', 'class', 'id', 'style']}
          selfClosing
        />
...
`<form action="/submit" method="post">
          ...
          attributes={['accept-charset', 'action', 'autocomplete', 'enctype', 'method', 'name', 'novalidate', 'target', 'class', 'id', 'style', 'onreset', 'onsubmit']}
        />
        ...
        <TagExample
          ...
          demo={
            <div className="space-y-4">
              {[
                { type: "text", name: "text", label: "Текст", value: formData.text },
                { type: "password", name: "password", label: "Пароль", value: formData.password },
                { type: "email", name: "email", label: "Email", value: formData.email },
                { type: "search", name: "search", label: "Пошук", value: formData.search },
                { type: "tel", name: "tel", label: "Телефон", value: formData.tel },
                { type: "url", name: "url", label: "URL", value: formData.url },
                { type: "number", name: "number", label: "Число", value: formData.number },
                {
                  type: "range",
                  name: "range",
                ...
                { type: "date", name: "date", label: "Дата", value: formData.date },
                { type: "time", name: "time", label: "Час", value: formData.time },
                { type: "datetime-local", name: "datetimeLocal", label: "Дата й час", value: formData.datetimeLocal },
                { type: "month", name: "month", label: "Місяць", value: formData.month },
                { type: "week", name: "week", label: "Тиждень", value: formData.week },
                { type: "color", name: "color", label: "Колір", value: formData.color },
                {
                  type: "checkbox",
                  name: "checkbox",
                  label: "Чекбокс",
          ...
          attributes={[
            'accept', 'autocomplete', 'checked', 'dirname', 'disabled',
            'form', 'formaction', 'formenctype', 'formmethod', 'formnovalidate',
            'formtarget', 'height', 'list', 'max', 'maxlength', 'min',
            'multiple', 'name', 'pattern', 'placeholder', 'readonly', 'required',
            'size', 'src', 'step', 'type', 'value', 'width', 'class', 'id', 'style'
          ]}
          selfClosing
        />
...
Текст за замовчуванням
          ...
          attributes={['cols', 'dirname', 'disabled', 'form', 'maxlength', 'name', 'placeholder', 'readonly', 'required', 'rows', 'wrap', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={
            <div className="flex gap-2 flex-wrap">
              <button type="button" className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded">
                Звичайна кнопка
              </button>
              <button type="submit" className="bg-green-600 hover:bg-green-700 px-4 py-2 rounded">
                Надіслати
              </button>
              <button type="reset" className="bg-red-600 hover:bg-red-700 px-4 py-2 rounded">
                Скинути
              </button>
              <button disabled className="bg-gray-600 px-4 py-2 rounded cursor-not-allowed">
                Неактивна
              </button>
            </div>
          }
          attributes={['autofocus', 'disabled', 'form', 'formaction', 'formenctype', 'formmethod', 'formnovalidate', 'formtarget', 'name', 'type', 'value', 'class', 'id', 'style']}
        />
...
`<select name="country">
  <option value="ua">Україна</option>
          ...
          attributes={['autocomplete', 'disabled', 'form', 'multiple', 'name', 'required', 'size', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          attributes={['disabled', 'label', 'selected', 'value', 'class', 'id', 'style']}
        />
...
`<fieldset>
  <legend>Персональні дані</legend>
        ...
        <TagExample
          ...
          demo={<output name="result" className="bg-gray-800 p-2 rounded">0</output>}
        ...
        <TagExample
          ...
          attributes={['value', 'min', 'max', 'low', 'high', 'optimum', 'form', 'class', 'id', 'style']}
        />
      </Section>
...
`<details>
  ...
  <p>Додаткова інформація.</p>
          ...
          demo={
            <details>
              <summary>Деталі</summary>
              <p>Це прихований контент, який розкривається при натисканні на заголовок.</p>
            </details>
          }
        ...
        <TagExample
          ...
          demo={<canvas id="myCanvas" width="200" height="100" className="border border-gray-600"></canvas>}
        ...
        <TagExample
          ...
          demo={<p>Користувач <bdi>اسم المستخدم</bdi> опублікував.</p>}
          attributes={['dir', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<p>Як сказано в <cite>Книзі</cite>.</p>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<code className="bg-gray-800 px-2 py-1 rounded font-mono">document.getElementById("demo");</code>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<p>Виділіть <mark className="bg-yellow-200 text-yellow-900">цей</mark> текст.</p>}
          attributes={['class', 'id', 'style']}
        />
          ...
          demo={
            <nav>
              <ul className="flex space-x-4">
                <li><a href="#nav1" className="text-blue-400 hover:underline">Головна</a></li>
                <li><a href="#nav2" className="text-blue-400 hover:underline">Про нас</a></li>
              </ul>
            </nav>
          }
          attributes={['class', 'id', 'style']}
        ...
        <TagExample
          ...
          demo={<output name="result" className="bg-gray-800 p-2 rounded">10</output>}
          attributes={['for', 'form', 'name', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<p>Він сказав <q>Привіт!</q></p>}
          attributes={['cite', 'class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<samp className="bg-gray-800 px-2 py-1 rounded font-mono">Вивід програми</samp>}
          attributes={['class', 'id', 'style']}
        />
        ...
        <TagExample
          ...
          demo={<p><small>Авторські права 2023</small></p>}
          attributes={['class', 'id', 'style']}
        />
